...
| `tests/intelligence/extraction/provider-boundary.test.ts` | Semantic Grounding | **KEEP** | Gate 1B targeted | 1 | 7 |
| `tests/intelligence/extraction/llm-experimental-provider.test.ts` | Semantic Grounding | **KEEP** | Gate 1B Batch 03 targeted | 1 | 10 |
