...
const TEST_URL = "https://in.indeed.com/viewjob?jk=e5b32ec34bc3db22";

async function runExperiment() {
  console.log('Starting Indeed Calibration Experiment (Playwright Stealth) for URL:', TEST_URL);
  ...
  try {
      ...
      if (!jdHtml) {
          throw new Error("Could not extract JD HTML from DOM.");
      }
